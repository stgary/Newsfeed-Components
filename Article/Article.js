...
function createComponent(obj) {
  ...
  article.append(title, date, button, firstParagraph, secondParagraph, thirdParagraph);
  ...
  button.innerHTML = '<button>Expand</button>';
...
// art.appendChild(createComponent(data));
